...
class LoginActivity : AppCompatActivity() {
    ...
    private lateinit var phoneEditTextNumber : EditText
    ...
    private fun init(){
        ...
        phoneEditTextNumber = findViewById(R.id.phoneEditTextNumber)
            ...
            .addOnCompleteListener(this) { task ->
                if (task.isSuccessful) {
                    ...
                    if (task.exception is FirebaseAuthInvalidCredentialsException) {
                        ...
                        Toast.makeText(this , "Authentication Unsuccessfully" , Toast.LENGTH_SHORT).show()
                    }
                    // Update UI
                }
                mProgressBar.visibility = View.INVISIBLE
